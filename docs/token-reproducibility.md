...
Seven targeted metadata/array cases plus 54 seeded generated spectra produced
366 identical tokens across the two profiles and three fixed compression modes.
The paper's 237-spectrum selection produced another 1,422 identical tokens.
Both runs had zero differences; their runtime versions are recorded in
